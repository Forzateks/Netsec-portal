...
function _amcRenderValueChart(rows) {
  ...
  var footnote = data.missingValue > 0
    ? '<div style="font-size:11px;color:var(--nx-orange-deep);font-style:italic;margin-top:6px">'+data.missingValue+' contract'+(data.missingValue===1?'':'s')+' excluded — no AMC value set</div>'
    : '';
